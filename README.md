...
- 우주선 도감: 임무 성공 시 우주선을 발견해 수집하며, 티어는 기체 등급(F~S)으로 통일합니다. 보상/성공률은 등급과 본체 +N의 등가 스탯·파츠 패시브가 담당합니다.
- 파츠 +N은 본체 강화 성공 시 성장하며 실패·정산에도 유지되는 영구 성장 축입니다. 현재 파츠 강화 자체에는 상한이 없습니다.
